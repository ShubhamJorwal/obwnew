...
const BookWomenServices = () => {
  ...
  const handleAddServices2O = () => {
    ...
    if (existingData) {
      ...
      localStorage.setItem("BookSelectedData", JSON.stringify(filteredDataArray));
    } else {
      const dataArray = [selectedData];
      localStorage.setItem("BookSelectedData", JSON.stringify(dataArray));
    }
  };
      ...
      >
        ...
        <div id="midcomp">
          ...
          <div id="SecCompForServices">
            ...
            <Link to={"/bookings/services/child"}>
              <div id="ChildService">
                <span>
                  {/* <img id="centerIconOnser" src="/icons/01.png" alt="" /> */}
                  <svg
...
export default BookWomenServices;
