...
import "./aptdetails.scss";

const AppointmentDetails = ({ aptcusid, aptid }) => {
  ...
  const fetchCustomers = async () => {
    try {
      ...
      const filteredCustomer = response.data.find((cust) => cust.id === cusid);
          ...
          <div id="Cus">
            {customer ? (
              ...
              >
                ...
                <p style={{ margin: "0 2rem" }}>
                  {customer.contact_no.substr(0, 6)}****
                </p>
